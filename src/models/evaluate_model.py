...
def main():
    ...
    val_clips = pd.read_csv('../../data/processed/validation.csv')
    ...
    plt.tight_layout()
    plt.savefig('../../reports/figures/Training_Average_Precision.png', format='png', bbox_inches='tight', pad_inches=0.1)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('../../reports/figures/Validation_Average_Precision.png', format='png', bbox_inches='tight', pad_inches=0.1)
    plt.show()
